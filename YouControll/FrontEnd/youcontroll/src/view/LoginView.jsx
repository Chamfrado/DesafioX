...
const Login = ({ handleLogin }) => {
	...
	const [alertIncorrect, setAlertIncorrect] = useState(false);
	...
	const handleSubmit = () => {
		if (user.username === "chamfrado" && user.password === "123") {
			...
			setAlertIncorrect(true);
		}
	};

	const toggleAlert = () => setAlertIncorrect(!alertIncorrect);
			...
			<Row >
				...
				<Col style={{marginTop: 20, marginRight: 20, marginBottom:10}} >
					...
					>
						...
						>
							<CardBody>
								{ alertIncorrect && <Alert toggle={toggleAlert} isOpen={alertIncorrect} color="danger" id="incorrectAlert" >Senha incorreta!</Alert>}
